...
def init_all_tables(db_path: str):
    ...
    # Step 2: The hospitalityclaw guests code references c.customer_name, c.email,
    # c.phone on the customer table via JOINs. Add these columns if missing.
...
def seed_customer(conn, company_id: str, name="Alice Guest",
    ...
    Populates both 'name' and 'customer_name' columns since hospitalityclaw
